...
static bool decompress_q0(uint16_t in, uint32_t *out) {
    ...
    switch (funct3) {
        case 0: {
            ...
            uint32_t nzuimm = (((in >> 11) & 0x3u) << 4) | (((in >> 7) & 0xfu) << 6) | (((in >> 6) & 0x1u) << 2) |
                              (((in >> 5) & 0x1u) << 3);
            if (nzuimm == 0)
        ...
        case 1: {
            ...
            uint32_t uimm = (((in >> 10) & 0x7u) << 3) | (((in >> 5) & 0x3u) << 6);
        ...
        case 2: {
            ...
            uint32_t uimm = (((in >> 10) & 0x7u) << 3) | (((in >> 6) & 0x1u) << 2) | (((in >> 5) & 0x1u) << 6);
    ...
    switch (funct3) {
        ...
        case 3: {
            ...
            if (rd == 2) {
                ...
                int32_t nzimm =
                    (int32_t)((((in >> 12) & 0x1u) << 9) | (((in >> 6) & 0x1u) << 4) | (((in >> 5) & 0x1u) << 6) |
                              (((in >> 3) & 0x3u) << 7) | (((in >> 2) & 0x1u) << 5));
                nzimm = (nzimm << 22) >> 22;
                if (nzimm == 0)
                    return false; // reserved
                *out = rv_enc_i(nzimm, 2, 0, 2, OP(RV_OP_MAJ_OP_IMM));
                ...
                int32_t nzimm = (int32_t)(((in >> 12) & 0x1u) << 5) | (int32_t)((in >> 2) & 0x1fu);
                nzimm         = (nzimm << 26) >> 26;
                if (nzimm == 0)
                    return false; // reserved
        ...
        case 4: {
            ...
            switch (funct2) {
                case 0: {
                    ...
                    *out           = rv_enc_i((int32_t)(shamt & 0x3fu), rdp, 5, rdp, OP(RV_OP_MAJ_OP_IMM));
                    return true;
                }
                case 1: {
                    // C.SRAI → SRAI rd', rd', shamt  (bit10 of imm set)
                    uint32_t shamt = ((in >> 7) & 0x20u) | ((in >> 2) & 0x1fu);
                    *out = rv_enc_i((int32_t)((1u << 10) | (shamt & 0x3fu)), rdp, 5, rdp, OP(RV_OP_MAJ_OP_IMM));
                    return true;
                }
                case 2: {
                ...
                case 3: {
                    ...
                    if (!is_w) {
                        ...
                        switch (op2) {
                            case 0:
                                *out = rv_enc_r(0x20, rs2p, rdp, 0, rdp, OP(RV_OP_MAJ_OP_32));
                                return true; // C.SUBW
                            case 1:
                                *out = rv_enc_r(0x00, rs2p, rdp, 0, rdp, OP(RV_OP_MAJ_OP_32));
                                return true;       // C.ADDW
        ...
        case 5: {
            ...
            int32_t offset =
                (int32_t)((((in >> 12) & 0x1u) << 11) | (((in >> 11) & 0x1u) << 4) | (((in >> 9) & 0x3u) << 8) |
                          (((in >> 8) & 0x1u) << 10) | (((in >> 7) & 0x1u) << 6) | (((in >> 6) & 0x1u) << 7) |
                          (((in >> 3) & 0x7u) << 1) | (((in >> 2) & 0x1u) << 5));
            offset = (offset << 20) >> 20;
        ...
        case 6: {
            ...
            int32_t  offset =
                (int32_t)((((in >> 12) & 0x1u) << 8) | (((in >> 10) & 0x3u) << 3) | (((in >> 5) & 0x3u) << 6) |
                          (((in >> 3) & 0x3u) << 1) | (((in >> 2) & 0x1u) << 5));
            offset = (offset << 23) >> 23;
...
static bool decompress_q2(uint16_t in, uint32_t *out) {
    ...
    switch (funct3) {
        ...
        case 1: {
            ...
            uint32_t rd   = (in >> 7) & 0x1fu;
            uint32_t uimm = (((in >> 12) & 0x1u) << 5) | (((in >> 5) & 0x3u) << 3) | (((in >> 2) & 0x7u) << 6);
        ...
        case 2: {
            ...
            if (rd == 0)
                return false; // reserved
            uint32_t uimm = (((in >> 12) & 0x1u) << 5) | (((in >> 4) & 0x7u) << 2) | (((in >> 2) & 0x3u) << 6);
        ...
        case 5: {
            ...
            uint32_t rs2  = (in >> 2) & 0x1fu;
            uint32_t uimm = (((in >> 10) & 0x7u) << 3) | (((in >> 7) & 0x7u) << 6);
        ...
        case 6: {
            ...
            uint32_t rs2  = (in >> 2) & 0x1fu;
            uint32_t uimm = (((in >> 9) & 0xfu) << 2) | (((in >> 7) & 0x3u) << 6);
